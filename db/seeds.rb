...
collector1 = Collector.create(name: "Sam Robinson", user_name: "UbuLaCroix")
collector2 = Collector.create(name: "Tom Brownlee", user_name: "ColorBrown")
collector3 = Collector.create(name: "Jack O Lantern", user_name: "Heady")
